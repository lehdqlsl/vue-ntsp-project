  ...
  <div>
    ...
    >
      ...
      <template v-slot:cell(처리)="data" v->
        <a href='#'><span v-html="data.value" v-if="data.value == '미처리'" style='color: #ff0000'></span></a>
        <a href='#'><span v-html="data.value" v-if="data.value == '처리'"></span></a>
      </template>
      <template v-slot:cell(상태)="data" v->
        <a href='#'><span v-html="data.value" v-if="data.value == '미처리'" style='color: #0ab961'></span></a>
        <a href='#'><span v-html="data.value" v-if="data.value == '해결됨'" style="color: #0ab961"></span></a>
      </template>
